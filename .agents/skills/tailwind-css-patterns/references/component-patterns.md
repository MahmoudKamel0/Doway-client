...
<div class="max-w-sm mx-auto bg-white rounded-xl shadow-lg overflow-hidden sm:flex sm:max-w-2xl">
    ...
    <div class="p-8">
        <div class="uppercase tracking-wide text-sm text-indigo-500 font-semibold"> Product Engineer </div>
        ...
        <button class="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition"> Contact </button>
    </div>
</div>
```
    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center h-16">
            <div class="flex items-center">
                <a class="text-xl font-bold text-gray-800" href="#">Logo</a>
            </div>
            <div class="hidden md:flex space-x-8">
                <a class="text-gray-700 hover:text-blue-600 transition" href="#">Home</a>
                <a class="text-gray-700 hover:text-blue-600 transition" href="#">About</a>
                <a class="text-gray-700 hover:text-blue-600 transition" href="#">Services</a>
                <a class="text-gray-700 hover:text-blue-600 transition" href="#">Contact</a>
            </div>
...
<form class="space-y-6 max-w-md mx-auto">
    ...
    <button class="w-full bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-blue-700 transition" type="submit">
        Sign In
    </button>
</form>
```
