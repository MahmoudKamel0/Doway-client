...
<div class="container mx-auto px-4">
    ...
    <div class="flex flex-col md:flex-row items-center gap-8 py-12">
        ...
        <div class="flex-1">
            <img class="w-full rounded-lg shadow-lg" src="hero.jpg" />
        </div>
    </div>
</div>
```
...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
    <div class="aspect-square bg-gray-200 rounded-lg overflow-hidden">
        <img class="w-full h-full object-cover hover:scale-105 transition" src="image1.jpg" />
    </div>
    <div class="aspect-square bg-gray-200 rounded-lg overflow-hidden">
        <img class="w-full h-full object-cover hover:scale-105 transition" src="image2.jpg" />
    </div>
    <!-- More items... -->
</div>
```
