...
impact: CRITICAL
impactDescription:
    Validating deep in business logic allows corrupt data to propagate; validating at boundaries catches issues before they spread
tags: parse, boundaries, architecture, defense-in-depth
---

## Validate at System Boundaries

Validate external data immediately when it enters your system—at API endpoints, form handlers, message queue consumers, and configuration
loaders. Validating deep in business logic allows corrupt data to propagate and makes debugging harder.
