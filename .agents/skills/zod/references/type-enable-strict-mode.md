...
impact: HIGH
impactDescription:
    Without strict mode, Zod's type inference is unreliable; undefined and null slip through, defeating the purpose of validation
tags: type, typescript, strict, configuration
---

## Enable TypeScript Strict Mode

Zod requires TypeScript's strict mode to work correctly. Without it, `undefined` sneaks into types, `null` checks are bypassed, and type
inference becomes unreliable. This undermines the type safety that Zod provides.
