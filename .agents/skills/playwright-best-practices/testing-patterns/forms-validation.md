...
> **When to use**: Testing form filling, submission, validation messages, multi-step wizards, dynamic fields, and auto-complete
> interactions.
...
**Use when**: Testing what happens after a form is submitted — success messages, redirects, error responses from the server, and loading
