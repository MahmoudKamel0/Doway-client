...
> **When to use**: Testing email verification, password reset, session timeout/expiration, or remember-me functionality. For basic auth
> setup (storage state, OAuth mocking, MFA, role-based access), see [authentication.md](authentication.md).
