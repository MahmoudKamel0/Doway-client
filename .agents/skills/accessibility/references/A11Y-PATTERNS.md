...
Practical, copy-paste-ready patterns for common accessibility requirements. Each pattern is self-contained and linked from the main
[SKILL.md](../SKILL.md).
...
Also applies to sliders, map panning, colour pickers, and similar drag-based widgets—always provide an equivalent click/tap or keyboard
path.
...
<div role="tablist" aria-label="Product information">
    <button id="tab-1" role="tab" aria-selected="true" aria-controls="panel-1">Description</button>
    <button id="tab-2" role="tab" tabindex="-1" aria-selected="false" aria-controls="panel-2">Reviews</button>
</div>
<div id="panel-1" role="tabpanel" aria-labelledby="tab-1">
    <!-- Panel content -->
</div>
<div id="panel-2" role="tabpanel" hidden aria-labelledby="tab-2">
    <!-- Panel content -->
</div>
```
